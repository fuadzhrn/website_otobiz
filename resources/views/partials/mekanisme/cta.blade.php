    ...
    <div class="container">
        <div class="mekanisme-cta fade-up">
            ...
            <div class="mekanisme-cta__actions">
                ...
                <a href="{{ $mekanismeContent->cta_secondary_button_link ?? '#' }}" class="btn mekanisme-btn mekanisme-btn--light">{{ $mekanismeContent->cta_secondary_button_text ?? 'Konsultasi Sekarang' }}</a>
                <a href="{{ $mekanismeContent->cta_third_button_link ?? '#' }}" class="btn mekanisme-btn mekanisme-btn--ghost">{{ $mekanismeContent->cta_third_button_text ?? 'Hubungi Tim Kami' }}</a>
            </div>
        </div>
    </div>
</section>
