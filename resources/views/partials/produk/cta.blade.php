    ...
    <div class="container">
        <div class="produk-cta__inner fade-up">
            ...
            <div class="produk-cta__actions">
                <a href="{{ $waLink }}" class="btn produk-btn produk-btn--primary">{{ $productContent->cta_primary_button_text ?? 'Konsultasi Sekarang' }}</a>
                ...
                <a href="{{ $waLink }}" class="btn produk-btn produk-btn--ghost">{{ $productContent->cta_third_button_text ?? 'Hubungi Tim Kami' }}</a>
            </div>
        </div>
    </div>
</section>
